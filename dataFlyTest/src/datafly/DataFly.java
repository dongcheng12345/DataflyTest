...
*/        myPrivateTable.printFormat();
        ...
        /*Output a file*/
        File outFile = new File("C:\\Users\\Hu DongCheng\\eclipse-workspace\\dataFlyTest\\src\\datafly\\outFile.txt");
        try {
   ...
   /* *//**
    ...
    public PrivateTable setup() throws FileNotFoundException, SQLException{
        ...
        attriNames="Race,DOB,ID,Sex,Allele 1,Allele 2";
        attributeNames=attriNames.split(",");
        myPrivateTable.setRowHeadings(attriNames);instead of hard-code, in future should be
        user input
        QiNames="DOB,ID";
        QuasiNames=QiNames.split(",");
...
*/        
        ...
        myPrivateTable.setTableValues("C:\\Users\\Hu DongCheng\\eclipse-workspace\\dataFlyTest\\src\\datafly\\tableInputs.txt");
    ...
    public PrivateTable startGeneralization(PrivateTable myPrivateTable) throws FileNotFoundException{
        ...
        while(seqOccursLessThanKTimes(freqSet, kAnon)){
            ...
            //System.out.println(indexOftree+"????");
            //System.out.println(colToBeGeneralized+"????");
    ...
    /*private int getIndexOftree(int toBeGeneralized) {
        ...
        {
    		//System.out.println(attributeNames[toBeGeneralized]+"poohuygu");
        	if(attributeNames[toBeGeneralized].equals(QuasiNames[i])) 
        	{
        		NoOftree=i;
        		System.out.println(NoOftree+"............."+QuasiNames[NoOftree]);
        		System.out.println(attributeNames[toBeGeneralized]);
        		break;
        	}
    ...
    public HashMap<ArrayList, Integer> getFreqSet(PrivateTable table){
        ...
        while(i < table.tableRows.size()){
            ...
            for(int x = 0; x < quasiColNum.size(); x++){
            	//System.out.println(quasiColNum.get(x));
    ...
    public ArrayList<DGHTree> createDGHTrees(PrivateTable table) throws FileNotFoundException{
        ...
        String header = "/Users/Hu DongCheng/eclipse-workspace/dataFlyTest/src/datafly/";
